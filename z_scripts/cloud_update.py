def repo_pull(home_dir, main_dir)
    ...
    # pullit
    os.system('cd %s' %repo_dir) #need to pull from the repo directory
    os.system('git pull')
...
def repo_commit(home_dir, main_dir, proj_name, task_name, task_details)
    ...
    # commit
    os.system('cd %s' %repo_dir) #need to be in the repo directory
...
def repo_push(home_dir, main_dir)
    ...
    # pushit
    os.system('cd %s' %repo_dir) #move into the repo directory
